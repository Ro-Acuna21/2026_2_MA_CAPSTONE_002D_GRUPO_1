...
export function createMockData(): ClinicData {
  ...
  const users = [
    user('u1', 'Alexis Administrador', 'admin@demo.cl', 'ADMIN', ['org1', 'org2']),
  ...
  const appointments = [
    ...
    ['a5', 'c11', 'p4', 'e4', 's6', nextBusinessDay(2), '10:30', '11:00', 'CONFIRMADA', 'u1'],
  ...
  return { organizations, users, patients, professionals, specialties, services, availability, appointments, history }
}
